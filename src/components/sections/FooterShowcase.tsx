...
export default function FooterShowcase() {
  return (
    <section
      className="relative flex items-center overflow-hidden bg-[#f6f3ee] text-[#18130f] min-h-[60vh]"
    >
      ...
      <div className="relative mx-auto w-full max-w-7xl px-6 py-12 md:px-10 md:py-16">
        <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-2 lg:grid-cols-[1.1fr_0.9fr] lg:gap-14">
          <div>
            <p className="mb-4 text-[0.7rem] uppercase tracking-[0.34em] text-[#766457]">
              Final section
            </p>
            ...
            <Link
              href="/projects"
              className="mt-12 md:mt-8 inline-flex items-center justify-center rounded-md border border-[#18130f] bg-[#18130f] px-6 py-4 text-sm uppercase tracking-[0.28em] text-white transition-colors hover:opacity-80"
            >
              Open Projects
            </Link>
          </div>
          ...
          >
            <div className="relative h-72 md:h-[22rem] lg:h-[29rem]">
              <Image
              ...
              <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-6">
                <p className="text-xs sm:text-[0.68rem] uppercase tracking-[0.28em] text-white/80">
                  Featured project preview
                </p>
                <span className="border border-white/60 px-4 py-2 text-xs uppercase tracking-[0.24em] text-white">
                  View
                </span>
              </div>
            </div>
