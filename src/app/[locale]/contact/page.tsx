...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      title: `${t("contactTitle")} | Konrad Kalinowski`,
      description: t("contactDescription"),
      type: "website",
    },
    twitter: {
  ...
  return (
    <main className="min-h-[60vh] bg-[#f7f5f1] px-4 pb-2 pt-[calc(4rem+env(safe-area-inset-top))] text-[#171310] md:px-8 md:pb-12 md:pt-20 overflow-x-hidden">
      <div className="relative mx-auto w-full max-w-7xl">
        ...
        <section
          id="contact"
          className="relative scroll-mt-24 md:scroll-mt-32 overflow-hidden border border-[#171310]/12 bg-[#f6f2ec]/95 shadow-[0_18px_60px_rgba(23,19,16,0.08)]"
        >
